    ...
    for parent, dirnames, filenames in os.walk(filepath):
        for filename in filenames:
            ...
            try:
                ...
                i += 1
                image_rotation(img,savefilepath,savde_filename=save_prefix+str(i)+'.jpg')
                i += 1
...
if __name__ == '__main__':
    # 设置图片路径
    filepath = "VOCdevkit/VOC2007/Image_strong/"

    # 设置扩充保存图片路径
    savefilepath ="E:/PyCharm/mu_biao_jian_ce/YOLOV4/yolov4-keras-master/VOCdevkit/VOC2007/Image_strong/"
